...
The $\preceq_{1:1}$ arrows serve to break a symmetry that would otherwise exist between observed toxicity and tolerability.  Intuitively, we can understand these arrows as establishing a prior expectation of toxicity rate under 0.5 {\em even at the highest dose}, so that observing a paired toxicity and non-toxicity at dose $D$ yields on balance an evidently less safe tally.
