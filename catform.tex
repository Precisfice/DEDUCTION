...
\end{lemma}
\begin{proof}
  Set $n = |q|+1, q_0 = (\frac{n}{n},...,\frac{n}{n})$ and $q_1 = (\frac{0}{n},...,\frac{0}{n})$, then whittle these down to $q$ by repeated, componentwise application of Facts~\ref{tox_d} and \ref{tol_d}.
\end{proof}
