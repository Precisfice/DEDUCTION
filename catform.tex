...
\begin{defn}\label{domon}
  A monoidal preorder relation $\le$ on $Q^D$ is \textbf{dose-monotone} iff it contains the following arrows $\forall j \in \{1,...,D-1\}$:
  $$
  \begin{aligned}
