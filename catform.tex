...
\begin{proof}
  ...
  \end{pmatrix},
  $$
  we obtain a 1-1 correspondence between formal differences $q' = q = (\Delta t,\Delta u)$ and elements $(\gamma,\eta) \in \mathbb{Z}^6$, which precisely those cases where $(\gamma,\eta) \in \N^6$ correspond to arrows $q \preceq_r q'$.
\end{proof}
