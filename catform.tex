...
\begin{nota}
  Let $\preceq_r$ denote the monoidal preorder relation generated by $\{\preceq_{tol_1} \cup \preceq_{titr} \cup \preceq_{1:r} \cup \preceq_{exch}\}$.
\end{nota}
...
\begin{defn}\label{lesaf^D}
  Let $\Q_r = (Q^D,\preceq_r)$ be the preorder generated by $\preceq_{ce} \cup \preceq_{dm}$.
\end{defn}
