...
The 'pasting diagram' on the right states a *universal mapping property* of $G = \text{Lan}_F\iota$, that any *other* $\D \xrightarrow{G'} \Q$ with natural transformation $\gamma : \iota \Rightarrow G'\circ F$ must have $\gamma$ factoring uniquely through $\eta$.
