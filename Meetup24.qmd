...
* Observe tallies may be related by *logical implication*
...
## Arrows of the preorder $(Q^D,\preceq)$

\begin{align*}
q + \langle\frac{1}{1},\frac{0}{1}\rangle_{j,k} &\preceq_\text{exch} \langle\frac{0}{1},\frac{1}{1}\rangle_{j,k} + q \quad \forall q \in Q^2, j<k \in \{1,...,D\}
\\
q + \langle\frac{1}{1}\rangle_j &\preceq_\text{tox} \langle\frac{0}{0}\rangle_j + q
\\
q +  \langle\frac{0}{0}\rangle_j &\preceq_\text{tol} \langle\frac{0}{1}\rangle_j + q
\\
q +  \langle\frac{0}{1}\rangle_j &\preceq_\text{titr} \langle\frac{0}{1}\rangle_{j+1} + q
\end{align*}

Transitive closure of $\preceq_{exch} \cup \preceq_{tox} \cup \preceq_{tol} \cup \preceq_{titr}$ yields $\preceq$.
