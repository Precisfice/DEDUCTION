...
%@ ;  Q1 = [0/0,1/1], Q2 = [1/2,0/1], M = [1/0,0/1]
%@ ;  Q1 = [0/0,1/1], Q2 = [1/2,0/2], M = [1/0,0/1]
%@ ;  Q1 = [0/0,1/2], Q2 = [1/1,0/2], M = [1/0,0/2]
%@ ;  Q1 = [0/0,1/2], Q2 = [1/2,0/2], M = [1/0,0/2]
%@ ;  Q1 = [0/0,2/2], Q2 = [1/1,0/0], M = [1/0,1/2]
%@ ;  Q1 = [0/0,2/2], Q2 = [1/1,0/1], M = [1/0,1/2]
...
%@ ;  Q1 = [1/1,0/0], Q2 = [0/0,2/2], M = [1/0,1/2]
%@ ;  Q1 = [1/1,0/1], Q2 = [0/0,1/1], M = [1/0,0/1]
%@ ;  Q1 = [1/1,0/1], Q2 = [0/0,2/2], M = [1/0,1/2]
%@ ;  Q1 = [1/1,1/1], Q2 = [2/2,0/1], M = [2/1,0/1]
%@ ;  Q1 = [1/1,1/1], Q2 = [2/2,0/2], M = [2/1,0/1]
%@ ;  Q1 = [0/1,2/2], Q2 = [2/2,0/2], M = [2/1,0/2]
%@ ;  Q1 = [1/1,0/2], Q2 = [0/0,1/1], M = [1/0,0/1]
...
%@ ;  Q1 = [1/2,0/1], Q2 = [0/0,1/1], M = [1/0,0/1]
%@ ;  Q1 = [1/2,0/1], Q2 = [0/0,2/2], M = [1/0,1/2]
%@ ;  Q1 = [2/2,0/1], Q2 = [0/0,2/2], M = [2/1,0/1]
%@ ;  Q1 = [2/2,0/1], Q2 = [1/1,1/1], M = [2/1,0/1]
%@ ;  Q1 = [2/2,0/1], Q2 = [1/1,2/2], M = [2/1,1/2]
%@ ;  Q1 = [1/2,0/2], Q2 = [0/0,1/1], M = [1/0,0/1]
...
%@ ;  Q1 = [2/2,0/2], Q2 = [1/1,1/1], M = [2/1,0/1]
